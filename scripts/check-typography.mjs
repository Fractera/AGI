...
const VENDORED = new Set([
  path.join("components", "ai-elements"),
  // 283-2: мастер «Стандартного хедера» — шаблон для ДРУГИХ служб узла (вход, данные, будущие элементы).
  // Он ставится в чужой репозиторий, где нет ни PageHeader, ни шкалы typography.tsx ядра: требовать их
  // значит сделать хедер неставящимся. Правило сюда не относится — файл не страница ядра.
  path.join("app", "[lang]", "(architectLayer)", "architect", "kits", "_header", "master"),
])
