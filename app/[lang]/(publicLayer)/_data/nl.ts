...
export const nl: HomeCell = {
  title: 'hello world',
  description: "Een voorlopige startpagina. De architectuur van de starter blijft volledig: talen, SEO, configuraties, menu en voettekst.",
  keywords: '',
  blocks: [{ kind: 'p', text: "AGI Fractera · lokale server" }],
  faq: [],
}
