...
export const tr: HomeCell = {
  title: 'hello world',
  description: "Geçici bir ana sayfa. Starter mimarisi eksiksiz duruyor: diller, SEO, yapılandırmalar, menü ve alt bilgi.",
  keywords: '',
  blocks: [{ kind: 'p', text: "AGI Fractera · yerel sunucu" }],
  faq: [],
}
