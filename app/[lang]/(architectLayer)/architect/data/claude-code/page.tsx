...
// РАЗДЕЛ «Claude Code subscription» — `/{lang}/architect/data/claude-code`.
//
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return <CollectionPage lang={lang} dir="/architect/data" page={data} content={content(lang)} widget={widget(lang)} />
}
