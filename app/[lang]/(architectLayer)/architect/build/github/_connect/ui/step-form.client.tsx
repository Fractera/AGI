...
export function StepForm({
  ...
  /**
   * База дверей мастера — `…/architect/build/github/api/connect`.
   *
   * 🔒 ПРИХОДИТ СВЕРХУ, А НЕ ПИШЕТСЯ ЗДЕСЬ (274-4). Двери лежат под `[lang]`, а островок языка не
   * знает; зашитый адрес был бы верен ровно до первой смены маршрута — и врал бы молча.
   */
  api: string;
  index: number;
  total: number;
