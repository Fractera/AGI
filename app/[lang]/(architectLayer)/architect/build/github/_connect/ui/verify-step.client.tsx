...
export function VerifyStep({
   ...
   * Адрес двери целиком.
   *
   * 🔒 УМОЛЧАНИЯ БОЛЬШЕ НЕТ (274-4): прежде здесь стоял адрес панели, и страница, забывшая передать
   * свой, молча стучалась в чужую дверь — то есть отказ выглядел бы как поломка GitHub.
   */
  endpoint: string;
  /**
