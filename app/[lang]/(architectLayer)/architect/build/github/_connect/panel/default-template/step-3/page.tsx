...
import { flowVerified, flowVerifiedAt } from "../../../server/launch-flow";
    ...
    >
      ...
      >
        <div className="flex flex-col gap-5">
          ...
          {verified ? (
            <StepNav
              prevHref={`${adminHref(lang, "project-start")}/step-2`}
              nextHref={
                DEFAULT_TEMPLATE_BUILT >= 4
                  ? `${adminHref(lang, "project-start")}/step-4`
                  : undefined
              }
          ...
          <VerifyStep
            endpoint={`${connectApi(lang)}/verify`}
            labels={{
              cta: x.cta,
              busy: x.busy,
