# `/architect/build/github/connect/step-3` — one step of the repository wizard

The visible part is **ported from the admin panel** (step 274) and lives in
`_connect/panel/default-template/step-3/page.tsx`. This folder holds only the wrapper our layer
