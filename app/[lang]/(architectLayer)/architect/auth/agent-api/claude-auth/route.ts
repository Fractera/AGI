// @api tell the auth agent page whether this machine has a Claude subscription
...
// имя службы вместо `auth`. Живёт в маршруте службы — удалили папку службы, ушла и дверь.
//
