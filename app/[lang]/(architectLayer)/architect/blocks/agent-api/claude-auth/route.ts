// @api tell the blocks agent page whether this machine has a Claude subscription
...
// имя службы вместо `blocks`. Живёт в маршруте службы — удалили папку службы, ушла и дверь.
//
