...
// РАЗДЕЛ «Schedule» — `/{lang}/architect/cron/schedule`.
//
...
export const generateMetadata = collectionMetadata(data, '/architect/cron')

export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
  const { lang } = await params
  return <CollectionPage lang={lang} dir="/architect/cron" page={data} content={content(lang)} />
}
