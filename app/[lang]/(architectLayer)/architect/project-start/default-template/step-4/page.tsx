...
export const generateMetadata = collectionMetadata(data, '/architect/project-start/default-template')

export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
  const { lang } = await params
  return <CollectionPage lang={lang} dir="/architect/project-start/default-template" page={data} content={content(lang)} widget={widget(lang)} />
}
