// @api tell the root agent page whether this machine has a Claude subscription
...
// имя службы вместо `root`. Живёт в маршруте службы — удалили папку службы, ушла и дверь.
//
