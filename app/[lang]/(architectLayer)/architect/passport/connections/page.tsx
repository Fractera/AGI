...
// РАЗДЕЛ «Links to other microservices» — `/{lang}/architect/passport/connections`.
//
...
export const generateMetadata = collectionMetadata(data, '/architect/passport')

export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
  const { lang } = await params
  return <CollectionPage lang={lang} dir="/architect/passport" page={data} content={content(lang)} />
}
