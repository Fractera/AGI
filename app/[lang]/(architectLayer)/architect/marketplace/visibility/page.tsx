...
// РАЗДЕЛ «Visibility in the Marketplace» — `/{lang}/architect/marketplace/visibility`.
//
...
export const generateMetadata = collectionMetadata(data, '/architect/marketplace')

export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
  const { lang } = await params
  return <CollectionPage lang={lang} dir="/architect/marketplace" page={data} content={content(lang)} />
}
